...
First, everyone should have R and RStudio installed on their computers. Here are some links to do that: https://cran.r-project.org/ (obviously... download R for windows if you have a PC or R for macOS if you are someone who uses that...) https://posit.co/download/rstudio-desktop/ Download R studio for whatever kind of laptop or computer you have.
...
* **Source Editor**: This is where you will be working most often. This is where you will write code that you want to save. Code is not *evaluated* in the editor. You are editing and saving your code here. To run code in the editor you need to press `Ctrl + enter`, or if you are a ... Mac user `command + enter`.
...
See the start of the [Intermediate R Course](https://erinmarjo.github.io/R_Basics/Intermediate_R) for help with R projects
...
raw_dat %>%
  head (5) ## take a look at the data
